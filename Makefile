...
# Targets
all: git0.$(EXT) git-remote-sqlite git-local-sqlite
...
git-local-sqlite: git-local-sqlite.c
...
clean:
	rm -f git0.$(EXT) git0.a git0.o git0_vtab.o git-remote-sqlite git-local-sqlite
